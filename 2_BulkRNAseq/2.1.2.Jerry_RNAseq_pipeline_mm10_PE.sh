...
# head -n 10000 Hs6st3iKO_RNAseq_male_cortex_WT_rep1_1.fastq >Test_1.fastq
# head -n 10000 Hs6st3iKO_RNAseq_male_cortex_WT_rep1_2.fastq >Test_2.fastq
# infile=(Test)

# infile=(Hs6st3iKO_RNAseq_male_cortex_WT_rep1 Hs6st3iKO_RNAseq_male_cortex_WT_rep2 Hs6st3iKO_RNAseq_male_cortex_WT_rep3 Hs6st3iKO_RNAseq_male_cortex_WT_rep4 Hs6st3iKO_RNAseq_male_cortex_WT_rep5 Hs6st3iKO_RNAseq_male_cortex_HOMO_rep1 Hs6st3iKO_RNAseq_male_cortex_HOMO_rep2 Hs6st3iKO_RNAseq_male_cortex_HOMO_rep3 Hs6st3iKO_RNAseq_male_cortex_HOMO_rep4 Hs6st3iKO_RNAseq_male_cortex_HOMO_rep5)

infile=(Hs6st3iKO_RNAseq_male_hippocampus_WT_rep1 Hs6st3iKO_RNAseq_male_hippocampus_WT_rep2 Hs6st3iKO_RNAseq_male_hippocampus_WT_rep3 Hs6st3iKO_RNAseq_male_hippocampus_WT_rep4 Hs6st3iKO_RNAseq_male_hippocampus_HOMO_rep1 Hs6st3iKO_RNAseq_male_hippocampus_HOMO_rep2 Hs6st3iKO_RNAseq_male_hippocampus_HOMO_rep3 Hs6st3iKO_RNAseq_male_hippocampus_HOMO_rep4 Hs6st3iKO_RNAseq_male_hippocampus_HOMO_rep5)

for inputname in "${infile[@]}"
do
    cd "/Users/jerry/Analysis/Project/iKO/RNAseq2022/FASTQ"
    ...
    mv "${inputname}.sam" "/Users/jerry/Analysis/Project/iKO/RNAseq2022/BAM"
    mv "${inputname}_1.fastq" ".."
    mv "${inputname}_2.fastq" ".."
#    rm "${inputname}_1.fastq"
#    rm "${inputname}_2.fastq"
    mv "${inputname}.Log" "/Users/jerry/Analysis/Project/iKO/RNAseq2022/Statistics"
...
#    gzip "${inputname}_2.fastq"
    ...
    gawk -v tag=${inputname} 'NR>25 { print > tag".sam.chr"$3}' "/Users/jerry/Analysis/Project/iKO/RNAseq2022/BAM/${inputname}.sam"



    #### Step 3: Generate bam and BigWig file from sam file
    printf "\n\n\nStep 3 of 3: generate bam and BigWig from SAM file \n\n"
    cd "/Users/jerry/Analysis/Project/iKO/RNAseq2022/BAM"
    # sam to bam
    ...
    # bam to BigWig
    lines=`expr $(wc -l < "/Users/jerry/Analysis/Project/iKO/RNAseq2022/BAM/${inputname}.sam"| tr -d " ") - 25` ## uniquely mapped reads
    ...
    mv "${inputname}_plus_${bw_value}.bw" "/Users/jerry/Analysis/Project/iKO/RNAseq2022/Tracks" 
    mv "${inputname}_minus_${bw_value}.bw" "/Users/jerry/Analysis/Project/iKO/RNAseq2022/Tracks"
